...
namespace webapi.event_.Controllers
{
    ...
    {
        private readonly IPresencasEventosRepository _presencasEventoRepository;
        ...
        [HttpPut("{id}")]
        public IActionResult Put (Guid id, PresencasEventos presneca)
        {
            try
            {
                _presencasEventoRepository.Atualizar(id, presneca);
                    return NoContent();
            }
            catch (Exception e)
            {
